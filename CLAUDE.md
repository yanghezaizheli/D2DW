...
- PWA 関連: `manifest.webmanifest`, `sw.js`, `assets/images/icon-192.png`, `assets/images/icon-512.png`, `assets/images/apple-touch-icon.png`
...
- 詳細地図素材: `assets/images/01nagazumi2-*.png`（元PDFがある場合は別途管理）
